...
def items_list(self):   # Devuelve todas las instancias de artículos propiedad de este artículo.
...
def show_items(self):   # Muestra el estado del inventario de la instancia del artículo que posee en un formato de tabla con las columnas ["Número", "Nombre del producto", "Cantidad", "Cantidad"].
    ...
    print(tabulate(table_data, headers=["número", "Nombre del producto", "Precio Unitario", "cant disponible"], tablefmt="grid"))    # tabulateモジュールを使ってテーブル形式で結果を出力
